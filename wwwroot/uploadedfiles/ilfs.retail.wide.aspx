<%@ Page Language="VB" AutoEventWireup="false" CodeFile="/uploadedFiles/retail/templates/ilfs/ilfs.retail.wide.aspx.vb" 
Inherits="ilfsRetailWide" Debug="true" %>
...
<a class="addthis_button_facebook"> </a><a class="addthis_button_print"> </a><a class="addthis_button_email"> </a><a class="addthis_button_linkedin"> </a><a class="addthis_button_compact"> </a><a class="addthis_counter addthis_bubble_style"> </a>
    ...
    <cms:ContentBlock ID="Javascript_Base_Files" runat="server" DefaultContentID="36" SuppressWrapperTags="true" />
