...
var fundGroupMain = (typeof fundsProfile === 'undefined') ? '72' : fundsProfile;
...
var retailFundGroupNamesLimits = (typeof fundGroupNamesLimits === 'undefined') ? ['Irish Life Indexed Funds','CORE','Protected Funds','ILIM Actively Managed Funds','External Fund Managers','Clear PRSA Managed Portfolios'] : fundGroupNamesLimits;
...
if(fundGroupMain =='73')
{
	retailFundGroupNames = ['Multi Asset Portfolio Funds','ILIM Indexed Funds','CORE','Protected Funds','ILIM Active Funds','External Funds','Public Sector Funds for Cornmarket'];
}
else
{
...
setProductFunds = function(data,productGroupID,name){
	...
	for (i=0;i<productGroupNames.length; i++){	
		...
		//console.log("localTableHolder[i] length "+localTableHolder[i].length);
	}
