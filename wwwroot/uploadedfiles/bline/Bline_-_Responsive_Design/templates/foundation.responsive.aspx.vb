...
Partial Class responsive
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		ilfsDefaultCSS.Text = api.GetContent(21346).Html
		
		ilfsDefaultMenu.Text = api.GetContent(21350).Html		
		ilfsDefaultFooter.Text = api.GetContent(21348).Html
		
		ilfsDefaultJS.Text = api.GetContent(21344).Html
