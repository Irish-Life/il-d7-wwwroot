/*###### For Bline only - This allows the Risk calculator to run on Bline    ######*/
var ajaxManager;
var fundCategoriesReceived = false;
var callbackTracking='<iframe src="http://fls.doubleclick.net/activityi;src=1459025;type=ilpro894;cat=arran426;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>';
var pensionTracking='<iframe src="http://fls.doubleclick.net/activityi;src=1459025;type=pensi182;cat=pensi809;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>';
/****
