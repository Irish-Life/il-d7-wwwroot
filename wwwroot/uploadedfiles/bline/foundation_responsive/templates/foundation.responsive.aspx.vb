...
Partial Class responsive
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		iqHeaderblock.Text = api.GetContent(19144).Html
		
		iqMenublock.Text = api.GetContent(19154).Html		
		iqFooterblock.Text = api.GetContent(19156).Html
		
		ilfsGeneralJS.Text = api.GetContent(19148).Html
