var app = {
    ...
    if(app.currentPage != 'main'  && app.currentPage != 'login' && app.currentPage != 'ret_login' && !app.firstTimeWelcomeScr) {
      ...
      $('.footer:last').css({
        background: 'url(/secureWeb/uploadedImages/Bline/MyBiz/img/header_logo@2x.png) no-repeat, url(/secureWeb/uploadedImages/Bline/MyBiz/img/header_logo_left@2x.png) repeat-x',
        height: '5.9em',
    ...
    switch(app.currentPage){
      ...
      case 'main':
          if(app.firstMenuSreen)   
              $('.footer:last').css({
                      background: 'url(/secureWeb/uploadedImages/bline/MyBiz/img/icon-irishlife-mybiz@2x-1.png) no-repeat',
                      height: '5.5em',
                      backgroundSize: '12em',
	...
	changePageAlt:function(page, trans)
	{
		...
		$('#the-page-content').load('/secureWeb/uploadedFiles/Bline/MyBiz/pages/'+page, function() {
	...
	addMainToTopOfPage: function()
	{
		...
		$('#mainNav').load('/secureWeb/uploadedFiles/Bline/MyBiz/pages/main.html', function() {
	...
	console.log('beforePageShowAlt ' + page);
        ...
        if(app.currentPage == 'welcome' && app.firstTimeWelcomeScr){
                $('.header:last').css({
                        background: '#5356a6 url(/secureWeb/uploadedImages/Bline/MyBiz/img/header_logo_touchless@2x.png)' ,
