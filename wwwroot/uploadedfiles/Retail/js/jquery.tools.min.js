...
$(document).ready(function () {
		var root = $(".scrollable").scrollable({circular: true}).autoscroll({ autoplay: true ,interval: 5000}).navigator();

		$("#homepageSlider").mouseenter(function() {
			$(this).find('.browse').addClass( 'show' );
		}).mouseleave(function() {
			$(this).find('.browse').removeClass( 'show' );
		});
});	