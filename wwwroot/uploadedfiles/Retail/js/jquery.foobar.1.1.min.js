...
$(function(){
  $.foobar({
	...
	"enableCookie": true,
	"messagesDelay": 7000,
    "displayDelay" : 2000, //display bar after 2 seconds
    "messages": [ 
      "The Irish Life <a href='http://www.irishlife.ie//protection/good-news-family-protection.html?guide=Y' onclick='if (_gaq) _gaq.push([\"_trackEvent\", \"foobar\", \"Guide\"]);' >Family Protection Guide</a> is now available.",
      "Got a question? Why not get a <a href='http://www.irishlife.ie/advice/arrange-a-financial-advisor-callback.html' onclick='if (_gaq) _gaq.push([\"_trackEvent\", \"foobar\", \"Callback\"]);'>Qualified Financial Advisor to call you back.</a> "
    ]
  });
});