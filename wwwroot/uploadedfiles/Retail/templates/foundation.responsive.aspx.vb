...
Partial Class responsive
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		iqHeaderblock.Text = api.GetContent(7294).Html
		iqMenublock.Text = api.GetContent(7300).Html
		iqFooterblock.Text = api.GetContent(7302).Html
		ilfsGeneralJS.Text = api.GetContent(7296).Html
