<%@ Page Language="VB" AutoEventWireup="false" CodeFile="/uploadedFiles/retail/templates/iq.retail.content.wide.custom.over50.aspx.vb" Inherits="retailcontent" Debug="true" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<asp:Literal ID="ilCustomeHeaderblock" runat="server"></asp:Literal>
...
<a class="addthis_button_facebook"> </a><a class="addthis_button_print"> </a><a class="addthis_button_email"> </a><a class="addthis_button_linkedin"> </a><a class="addthis_button_compact"> </a><a class="addthis_counter addthis_bubble_style"> </a>
	...
	<asp:Literal ID="ilCustomJavascript" runat="server"></asp:Literal>
