...
Partial Class retaillandingpage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		iqHeaderblock.Text = api.GetContent(17624).Html
		iqMenublock.Text = api.GetContent(15696).Html
		iqFooterblock.Text = api.GetContent(15700).Html
		iqContentPremiumJavascript.Text = api.GetContent(17700).Html
