<%@ Page Language="VB" AutoEventWireup="false" CodeFile="/uploadedFiles/retail/templates/iq.retail.financial.advisor.aspx.vb" 
Inherits="financialadvisorcontent" Debug="false" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript" src="/uploadedFiles/retail/js/adviserData.js"></script>
	</head>
<body>
...
<a class="addthis_button_facebook"> </a><a class="addthis_button_print"> </a><a class="addthis_button_email"> </a><a class="addthis_button_linkedin"> </a><a class="addthis_button_compact"> </a><a class="addthis_counter addthis_bubble_style"> </a>
				...
				<asp:Literal ID="staticAdvisorPage" runat="server"></asp:Literal>
...
<script type="text/javascript" src="/uploadedFiles/retail/js/jquery-1.4.3.min.js"><!--

//--></script><script type="text/javascript" src="/uploadedFiles/retail/js/jquery-ui-1.8.7.custom.min.js"><!--

//--></script><script type="text/javascript" src="/uploadedFiles/retail/js/iq.jquery.cookie.js"><!--

//--></script><script type="text/javascript" src="/uploadedFiles/retail/js/iq.master.uncompressed.js"><!--

//--></script><script type="text/javascript" src="/uploadedFiles/retail/js/logger.js"><!--

//--></script>
	<asp:Literal ID="iqAddthisToolBoxJavascript" runat="server"></asp:Literal>
	<asp:Literal ID="mapGenericJavascript" runat="server"></asp:Literal>
	<asp:Literal ID="financialAdvisorJavascript" runat="server"></asp:Literal>
