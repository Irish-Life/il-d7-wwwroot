<%@ Page Language="VB" AutoEventWireup="false" CodeFile="/uploadedFiles/retail/templates/iq.retail.content.wide.custom.quote.premium.naked.aspx.vb" Inherits="retaillandingpage" Debug="false" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<!--[if lte IE 7]> <link rel='stylesheet' type='text/css' href="https://www.irishlife.ie/secureWeb/uploadedImages/Retail/css/iq.naughty_ie.css"> <![endif]-->
	</head>
<body>
<div id='bodyContainer'>
	...
	<asp:Literal ID="iqContentPremiumJavascript" runat="server"></asp:Literal>
</body>
</html>