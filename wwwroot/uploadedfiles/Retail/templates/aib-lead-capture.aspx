...
if password = "kfkskfi5683495493kfkfkgkdkgk" Then
Response.Write(""& _
...
"h1 {color:#5a2049;font-size:48px;font-weight:bold}" & vbCrLf & _
...
"function isAIBEmail(emailAddressIn) " & vbCrLf & _
"{" & vbCrLf & _
	"if (emailAddressIn.indexOf(""@aib.ie"") > -1)  " & vbCrLf & _
	"{  " & vbCrLf & _
...
"</script>" & vbCrLf & _
"" & vbCrLf & _
"<link rel=""shortcut icon"" href=""https://personal.aib.ie/etc/designs/aib/personal/images/favicons/favicon.ico"" type=""image/x-icon"" />" & vbCrLf & _
"<link rel=""icon"" href=""https://personal.aib.ie/etc/designs/aib/personal/images/favicons/favicon.ico"" type=""image/x-icon"" />" & vbCrLf & _
"<style type=""text/css"">" & vbCrLf & _
".hidden {display:none !important}" & vbCrLf & _
"DIV#mktContent{height: 550px; z-index: auto; }" & vbCrLf & _
"DIV#mktHeader{height: 165px; }</style><title>AIB Referral</title>" & vbCrLf & _
...
"<li  class='mktFormReq mktField hidden'><label>Lead Source:</label>" & vbCrLf & _
"<span class='mktInput'>" & vbCrLf & _
"<select class='mktFormSelect mktFReq' name=""LeadSource"" id=""LeadSource"" size='1'  tabIndex='6'>" & vbCrLf & _
"""<option value='' >Select...</option><option value='Direct Sales' selected='selected'>Direct Sales</option><option value='Direct" & vbCrLf & _
" Service'>Direct Service</option><option value='Baggot St'>Baggot St.</option><option value='Grand Canal - Dublin'>Grand Canal - Dublin</option><option value='Cork'>Cork</option><option value='Galway'>Galway</option><option " & vbCrLf & _
...
"<span class='mktInput'>" & vbCrLf & _
"<select class='mktFormSelect mktFReq' name=""AreaofInterest"" id=""AreaofInterest"" size='1'  tabIndex='7'>" & vbCrLf & _
...
"<option value='Income Insurance'>Income Insurance</option><option value='Pensions'>Pensions</option><option value='Lump Sum Investments'>Lump Sum Investments</option><option value='Regular Savings'>Regular Savings</option></select><div class='mktFormMsg'></div></span></li>" & vbCrLf & _
...
"" & vbCrLf & _
"<li  class='mktFormReq mktField hidden'><label>Exisitng Customer:</label>" & vbCrLf & _
"<span class='mktInput'>" & vbCrLf & _
"<select class='mktFormSelect mktFReq' name=""ExistingCustomer"" id=""ExistingCustomer"" size='1'  tabIndex='9'>" & vbCrLf & _
"<option value='' >Select...</option><option value='Yes'>Yes</option><option value='No' selected='selected'>No</option></select><div" & vbCrLf & _ 
"class='mktFormMsg'></div></span></li>" & vbCrLf & _
"" & vbCrLf & _
"<li  class='mktFormReq mktField hidden' ><label>Staff ID:</label><span class='mktInput'><input class='mktFormText mktFReq' name=""StaffID""" & vbCrLf & _ 
"id=""StaffID"" type='text' value=""123456""  maxlength='255' tabIndex='10' /><span class='mktFormMsg'></span></span></li>" & vbCrLf & _
"<li  class='mktFormReq mktField hidden' ><label>Staff Name:</label><span class='mktInput'><input class='mktFormText mktFReq'" & vbCrLf & _ 
"name=""StaffName"" id=""StaffName"" type='text' value=""AIB Staff""  maxlength='255' tabIndex='11' /><span" & vbCrLf & _ 
"class='mktFormMsg'></span></span></li>" & vbCrLf & _
...
"name=""LeadSourceDetail"" id=""LeadSourceDetail"" type='hidden' value=""AIB Internal Referral"" /><span class='mktFormMsg'></span></span></li>" & vbCrLf & _
"<li  class='mktField' style=""display: none;""><label>Last Staff Name:</label><span class='mktInput'><input class='mktFormHidden'" & vbCrLf & _ 
"name=""StaffName"" id=""StaffName"" type='hidden' value=""Customer Service"" /><span class='mktFormMsg'></span></span></li>" & vbCrLf & _
...
"{" & vbCrLf & _
  ...
  "{" & vbCrLf & _
	...
	"valid = false;" & vbCrLf & _
  "}" & vbCrLf & _
    "if (valid && isAIBEmail(document.getElementById('Email').value.toLowerCase()))" & vbCrLf & _
  "{" & vbCrLf & _
	"alert('You cannot use AIB email addresses here');" & vbCrLf & _
	"valid = false;" & vbCrLf & _
  "}" & vbCrLf & _  
"  " & vbCrLf & _
"  " & vbCrLf & _
...
"  " & vbCrLf & _
  ...
  "}" & vbCrLf & _
"  " & vbCrLf & _
  "if (valid && document.getElementById('LeadSource').value == '')" & vbCrLf & _
  "{" & vbCrLf & _
	"alert('Lead Source is required');" & vbCrLf & _
	"valid = false;" & vbCrLf & _
  "}" & vbCrLf & _
"  " & vbCrLf & _
    "if (valid && document.getElementById('AreaofInterest').value == '')" & vbCrLf & _
  "{" & vbCrLf & _
...
"  " & vbCrLf & _
  ...
  "}" & vbCrLf & _
"	" & vbCrLf & _
	  "if (valid && document.getElementById('ExistingCustomer').value == '')" & vbCrLf & _
  "{" & vbCrLf & _
	"alert('Existing Customer is required');" & vbCrLf & _
	"valid = false;" & vbCrLf & _
  "}" & vbCrLf & _
"  " & vbCrLf & _
    "//if (valid && document.getElementById('StaffID').value == '')" & vbCrLf & _
  "//{" & vbCrLf & _
	"//alert('Staff ID is required');" & vbCrLf & _
	"//valid = false;" & vbCrLf & _
  "//}" & vbCrLf & _
"  " & vbCrLf & _
    "//if (valid && document.getElementById('StaffName').value == '')" & vbCrLf & _
  "//{" & vbCrLf & _
	"//alert('Staff Name is required');" & vbCrLf & _
	"//valid = false;" & vbCrLf & _
  "//}" & vbCrLf & _
"" & vbCrLf & _
	"return valid;" & vbCrLf & _
...
"  " & vbCrLf & _
  ...
  "document.getElementById('AreaofInterest').value," & vbCrLf & _
  ...
  "document.getElementById('LeadSource').value," & vbCrLf & _
  "document.getElementById('ExistingCustomer').value," & vbCrLf & _
  "document.getElementById('StaffID').value," & vbCrLf & _
  "document.getElementById('StaffName').value);" & vbCrLf & _
"  " & vbCrLf & _
...
"document.getElementById('StaffID').value = gup('StaffID').replace(""%20"","" "");" & vbCrLf & _
...
"<div id=""mktHeader"" class=""mktEditable"">" & vbCrLf & _
  "<div class=""logo""><a href=""http://www.aib.ie"">" & vbCrLf & _
  "<img style=""float: left;"" src=""https://www.irishlife.ie/secureWeb/uploadedImages/aib.png""></a>" & vbCrLf & _
  "<div style=""float:left;margin-left:20px""><h1>Lead Referral Page</h1></div></div>" & vbCrLf & _
"</div>" & vbCrLf & _
"" & vbCrLf & _
"" & vbCrLf & _
...
"<small>" & vbCrLf & _
" ALLIED IRISH BANKS, P.L.C. IS REGULATED BY THE CENTRAL BANK OF IRELAND." & vbCrLf & _
"Registered in the Republic of Ireland. Number 24173" & vbCrLf & _
"<br />Irish Life Financial Services ltd. is regulated by the Central Bank of Ireland. Irish Life Assurance plc. is regulated by the Central Bank of" & vbCrLf & _ 
"Ireland.<br>" & vbCrLf & _
"<br />Irish Life Financial Services ltd and Irish Life Assurance plc Registered Office - Lower Abbey Street, PO Box 129, Freepost, Dublin 1. Phone:" & vbCrLf & _ 
...
"<script src=""/secureWeb/uploadedFiles/retail/js/mk.js?200614"" type=""text/javascript""></script></body>")
End If
%>
</html>